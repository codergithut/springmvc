...
public class FileCharsetDetector {
    ...
    public String guessFileEncoding(InputStream file) throws FileNotFoundException, IOException {
        return guessFileEncoding(file, new nsDetector());
    }
     ...
     * @throws IOException
     */
    private String guessFileEncoding(Object file, nsDetector det) throws FileNotFoundException, IOException {
        // Set an observer...
        ...
        if(file instanceof File){
            imp = new BufferedInputStream(new FileInputStream((File)file));
        }else if(file instanceof InputStream){
            imp= new BufferedInputStream((InputStream)file);
        }
